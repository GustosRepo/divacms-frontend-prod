    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 py-24">
        ...
        <nav className="mb-8 text-sm">
          ...
          <span className="mx-2">→</span>
          <span className="text-fg/70">Y2K Nail Trends 2025</span>
        </nav>
        ...
        <div className="prose prose-lg max-w-none">
          <h2 className="font-shuneva text-3xl font-bold text-accent mt-12 mb-6">1. Holographic Everything 🌈</h2>
          ...
          <h2 className="font-shuneva text-3xl font-bold text-accent mt-12 mb-6">3. French Tips with a Twist 💅</h2>
          <p className="leading-relaxed mb-6">
